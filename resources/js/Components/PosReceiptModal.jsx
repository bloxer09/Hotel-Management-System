        ...
        <AnimatePresence>
            <div className="fixed inset-0 bg-[#070b13]/90 z-[99999] flex items-center justify-center p-4 print-bg-transparent">
                ...
                <motion.div
                    ...
                    className="bg-[#1e293b] border border-[#334155] rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh] print:shadow-none print:border-none print:max-w-full print:max-h-none print:bg-white"
                >
